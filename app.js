...
const STYLE_PRESETS = [
  ...
  { id: 'caricature', name: '캐리커쳐', emoji: '🤪', description: '과장된 특징, 유머러스한 캐리커쳐', prompt: 'Create a professional caricature based on the reference photo, dramatically exaggerating the person\'s most distinctive facial features (big nose, wide smile, prominent chin, etc.) while keeping them recognizable, bold colorful style with dynamic poses, humorous and expressive, hand-drawn editorial caricature look with confident brush strokes' }
];
